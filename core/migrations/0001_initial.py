    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schedule_location', models.CharField(blank=True, help_text='Full address where the dog walking service will be provided', max_length=200, null=True)),
                ('schedule_dogs', models.IntegerField(help_text='Number of dogs to be walked during this service (minimum 1)', validators=[django.core.validators.MinValueValidator(1)])),
                ('schedule_notes', models.TextField(blank=True, help_text='Additional notes or special instructions for the dog walker', null=True)),
