"""
Django settings for dogwalking_django project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-&#t2frsd#ny@ft0n9vl5p6#_b@mo5-y(3-^hic%@r$vvea^59p')
...
ROOT_URLCONF = 'dogwalking_django.urls'
...
WSGI_APPLICATION = 'dogwalking_django.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'app.db',  # Use existing app.db
    }
}
...
TIME_ZONE = 'Australia/Brisbane'  # Match the existing app timezone
...
# Stripe settings (for compatibility with existing code)
